...
* TODO   ToDo
  ...
  * [X] Get icons working in QT5.
  * [X] Make greetd run last so it's not covered by boot messages
  * [X] Get fecking clipboard history working again - particularly with Emacs!
