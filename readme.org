...
- For Visual Code
  ...
  # I'm sorry ;-)
  #+end_src
- Disable watchdogs by appending ~nowatchdog~ to the [[https://wiki.archlinux.org/title/kernel_parameters][kernel parameters]].
...
* ToDo
  * [ ] Use lynis (doh, the audit report itself tells you how to plug holes) to plug holes.
