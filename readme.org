...
* Still left to do
  - [ ] Theme SwayNC.
  - [ ] Fix emacs theming - fucking again.
  - [ ] Fix whatami's power governer thingie.
  - [ ] Nice to have
    - [ ] GTK theming
  ...
  - [ ] Unfuck Emacs theming.  Maybe go back to ewal.
  - [ ] Improve Emacs sart-up speed.
  - [ ] Find out why  can never see cdn77.
  - [ ] Install =copyparty= onto pi.
  - [X] Swap out TLP for whatever Cachy defaults to.
  ...
  - [X] Get udiskie to open folders in Thunar (may require un-fucking xdg-open?).
  - [X] Add SwayNC.
  ...
  - [ ] Check out the wallust emacs theme [[https://codeberg.org/explosion-mental/wallust-templates/src/branch/master/doom-wallust-dark-theme.el][here]].
