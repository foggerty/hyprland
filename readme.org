...
* Still left to do
  ...
  - [ ] Add GTK/QT theming.
  - [ ] Set background Arch icon when hovered, to something else (with animation).
  - [ ] Thunar isn't remembering size or position.  Fix.  Check if it does in Niri.
  ...
  - [X] Go through [[https://joshblais.com/blog/how-i-am-deeply-integrating-emacs/][this]] for some Emacs ideas.
  - [X] Swear at Hyprland until Waybar gets blur back.
