...
* Still left to do
  - [X] Replace pwaudio thingie with hyprpwmanager.
  - [X] Try again, to find a wayland replacement for feh.
  - [X] Add info button to waybar, and hyprinfo to bootstrap-desktop.
  - [X] Get bloody hyprlock working.
  - [X] look into hyprlauncher, and then hyprbar.
  - [X] See if can get pacdiff configured to use a good diff tool.

  - [X] Fix Kitty colours.
  - [X] Fix waybar colours.
  - [X] Fix hyprland colours.
  - [ ] Fix rofi colours.
  - [ ] Fix wlogout colours.
  - [ ] Fix hyprtoolkit colors?

  - [ ] See if [[https://github.com/end-4/dots-hyprland/blob/main/dots-extra/emacs/material-theme.el][this]] looks better in emacs.
  ...
  - [X] Back to making wlogout look pretty: `wlogout -b 6`, and add a CSS "glow" (i.e. nick it from someone else's config, I've seen it somewhere....).
  - [X] Add adw-gtk3 theme to bootstrap-desktop
  - [X] Add hyprshutdown.
  - [X] Move back to wofi.
  - [X] Fix wlogout colours.
